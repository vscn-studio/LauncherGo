...
(() => {
  ...
  Object.assign(words.zh,{'waiting-save':'等待游戏保存完成','waiting-colormap':'等待管理员客户端色表',build:'建立缓存',changes:'更新变化区域',season:'更新季节颜色',rebuild:'重建缓存',recovery:'恢复核对',repair:'修复缓存',render:'全图重绘',surface:'地表提取',coloring:'着色',parents:'缩放瓦片',indexing:'传送器检查（柱）',sessionCompleted:'本次运行累计完成',surfaceColumns:'地表提取（柱）',colorTiles:'着色（张）',parentTiles:'缩放瓦片（张）',translocatorEndpoints:'传送器端点（个）',deferredGeneration:'边缘地形未生成（柱，探索后更新）',pendingSaveColumns:'等待游戏保存（柱）'});
  Object.assign(words.en,{'waiting-save':'Waiting for world save completion','waiting-colormap':'Waiting for an administrator client colormap',build:'Building cache',changes:'Updating changed regions',season:'Updating seasonal colors',rebuild:'Rebuilding cache',recovery:'Checking recovery',repair:'Repairing cache',render:'Redrawing map',surface:'Surface extraction',coloring:'Coloring',parents:'Parent tiles',indexing:'Translocator checks (columns)',sessionCompleted:'Completed this session',surfaceColumns:'Surface extraction (columns)',colorTiles:'Coloring (tiles)',parentTiles:'Parent tiles (tiles)',translocatorEndpoints:'Translocator endpoints',deferredGeneration:'Unfinished border columns (update after exploration)',pendingSaveColumns:'Awaiting game save (columns)'});
